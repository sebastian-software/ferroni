...
This is the initial, pre-#178 evaluation. The
[expanded Unicode evaluation](/perf/unicode-range-lookup-expanded) repeats
41 workloads on the newer base and supersedes this report's merge assessment.
The later [direct interval search refinement](/perf/unicode-range-lookup-refinement)
replaces the implementation evaluated in both earlier reports.
