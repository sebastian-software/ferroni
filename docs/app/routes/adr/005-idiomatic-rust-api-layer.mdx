...
- The Scanner API ([ADR-006](../006-scanner-api)) extends this layer with a domain-specific multi-pattern interface for TextMate grammar tokenization, following the same principle of wrapping C-ported internals without modification.
