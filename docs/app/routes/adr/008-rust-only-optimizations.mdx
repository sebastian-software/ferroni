...
#### Second 2026-09 pass (`src/regset.rs`, `src/regcomp.rs`, `src/regparse.rs`, `src/literal_trie.rs`)
...
- **Fast-path census**: `grammar_fast_path_census` asserts how many grammar patterns reach each of these paths.
- **Impact**: warm TypeScript line -49%, Rust document -31%, CSS grammar compile -24%, TypeScript compile -17% (wall clock).
