---
order: 11
title: "Test Strategy and C Test Suite Parity"
---

# Test Strategy and C Test Suite Parity
...
> **Update:** this test is no longer ignored. It now finishes like any other
> test, and the tree has no `#[ignore]` tests left, so `cargo test -- --ignored`
> runs nothing. The original decision is kept below for the record.
