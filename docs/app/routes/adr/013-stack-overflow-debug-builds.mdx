...
repository. README, CONTRIBUTING, AGENTS, and the CI workflow link to or reuse
these values in their runnable guidance.
...
| Release builds with coverage instrumentation | `268435456` (256 MiB) | Coverage bookkeeping adds frames; CI additionally skips the deepest recursive tests |
