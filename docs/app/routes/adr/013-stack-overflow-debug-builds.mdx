...
This table is the single source for `RUST_MIN_STACK` in this repository.
README, CONTRIBUTING, AGENTS, and the CI workflow reference it instead of
stating their own values.
...
| Release / coverage instrumentation | `268435456` (256 MiB) | Coverage bookkeeping adds frames; CI additionally skips the deepest recursive tests |
| Unaffected | not needed | Release builds, and any suite other than `compat_utf8` / `compat_back` |
