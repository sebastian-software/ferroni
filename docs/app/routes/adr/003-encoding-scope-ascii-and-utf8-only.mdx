---
order: 3
title: "Encoding Scope — ASCII and UTF-8 Only"
---
...
- The `Encoding` trait and dispatch infrastructure exist and are fully functional — additional encodings _could_ be added, but we choose not to.
